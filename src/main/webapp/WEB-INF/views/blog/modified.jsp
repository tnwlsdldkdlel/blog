...
<body>
	...
	<div class="container">
		<c:forEach items="${content }" var="content">
			<form action="/blog/myblog/boardContent/modified?bno=${content.bno }" method="post">
				<div class="form-group">
					<label for="exampleFormControlInput1">title</label>
					<input type="text" class="form-control" name="title" value='<c:out value="${content.title }"/>'/>
				</div>

				<div class="form-group">
					<label for="exampleFormControlInput1">id</label> <input type="text"
						class="form-control" name="id" readonly="readonly" value='<c:out value="${content.id }"/>'
